...
public class CatalogController {
	...
	public @ResponseBody ResponseEntity<Product> getByDescription(@RequestParam("description") String description) throws ProductNotFoundException  {
		Product product = productService.findBy(description);
		return new ResponseEntity<Product> (product, HttpStatus.OK);
	}

	@RequestMapping(value = "/products?catagory={catagory}", method = RequestMethod.GET)
